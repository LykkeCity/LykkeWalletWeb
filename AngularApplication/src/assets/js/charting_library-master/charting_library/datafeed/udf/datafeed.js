...
Datafeeds.UDFCompatibleDatafeed.prototype._initialize = function() {
	...
	// this._send(this._datafeedURL + '/config')
        ...
        "supported_resolutions":["1","D", "2D", "3D", "W", "3W", "M", "6M"]
      };
      that._setupWithConfiguration(parseJSONorNot(configurationData));
    })
...
Datafeeds.UDFCompatibleDatafeed.prototype.getBars = function(symbolInfo, resolution, rangeStartDate, rangeEndDate, onDataCallback, onErrorCallback) {
  ...
  var dataService = new datafeedService(rangeStartDate, rangeEndDate);

  // dataService.init().done(function(data) {
  //   console.log(dataService.convertApiDataToChartFormat(data.History));
  // });

  // this._send('https://apiv2-dev.lykkex.net/api/CandleSticks/BTCUSD/Mid/Day/' + rangeStartDate + '/' + rangeEndDate).done(function(data) {console.log(data)});
  ...
  // this._send(this._datafeedURL + this._historyURL, {
	...
	// 	to: rangeEndDate
	// })
  dataService.init() // get data from API v2
	.done(function(response) {
	  // dataService.convertApiDataToChartFormat(response.History);
		// var data = parseJSONorNot(response);
		var data = dataService.convertApiDataToChartFormat(response.History);
