  ...
  if (!window.TradingView) {
    var n = {
      ...
      d = {
        ...
        HOLLOW_CANDLES: 9,
        version: function() {
          return "1.10 (internal id 22011445 @ 2017-07-18 06:15:57.098661)"
        },
        gEl: function(a) {
    ...
    d.widget.prototype = {
      ...
      render: function() {
        ...
        var a = (this.options.path || "") + "static/tv-chart.2201144508e5c17a3a1e.html#localserver=1&symbol=" + encodeURIComponent(this.options.symbol) + "&interval=" + encodeURIComponent(this.options.interval) + (this.options.timeframe ?
