...
@Component({
  selector: 'app-hf-wallet-list',
  templateUrl: './hf-wallet-list.component.html',
  styleUrls: ['./hf-wallet-list.component.scss'],
  providers: [TradingWalletService]
})
export class HfWalletListComponent implements OnInit {
